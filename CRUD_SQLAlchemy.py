# A WEB APPLICATION TO MANAGE THE EMPLOYEE DETAILS BY USING ((Python)FLASK ) ORM SQLAlchemy
...
@app.route('/')
def employees_list():
    return render_template('employees_list.html',Employees=Employees.query.all())
